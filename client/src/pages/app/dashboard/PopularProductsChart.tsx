import { getPopularProducts } from "@/api/get-popular-productst";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";
import { useQuery } from "@tanstack/react-query";
import { Loader2 } from "lucide-react";
import { BarChart, Cell, Pie, PieChart, ResponsiveContainer, Tooltip, TooltipProps } from "recharts";
    ...
    return (
        <Card className="col-span-3">
            <CardHeader className="pb-8">
                ...
                <CardDescription>The 5 products with more sales</CardDescription>
            </CardHeader>
            <CardContent>
                {popularProducts ? (
